...
export const ACTIVITY_FEED: ActivityEvent[] = [
  {
    ...
    summary:
      "Enterprise Data Platform detected vendor delay for RM-PR-3120 at VP01 — second detection, appended to existing case",
  ...
  },
  {
    ...
    summary: "Case opened automatically from enterprise data platform signal SIG-2026-08-13-IN-00412",
  ...
  },
  {
    ...
    summary: "Verified corrective action on the resin delay — evidence accepted",
  ...
  },
  {
    ...
    summary: "Completed 'Raise the expedite and confirm freight mode' with 2 attachments",
...
export const TODAYS_ACTIONS: ActionItem[] = [
  {
    id: "actn_101",
    caseId: "case_qo_pa_2026_00418",
    caseNo: "QO-PA-2026-00418",
    caseTitle: "Packaging material shortage — HDPE pails",
  ...
  {
    id: "actn_102",
    caseId: "case_qo_pa_2026_00406",
    caseNo: "QO-PA-2026-00406",
    caseTitle: "Quality release delay — admixture batch AD-8842",
    title: "Escalate to the quality lead for a priority release slot",
    description:
...
export const NOTIFICATIONS = [
  {
    id: "ntf_1",
    title: "Case escalated to level 1",
    body: "QO-PA-2026-00421 passed its resolution target and was raised above the owner",
    at: ago(6 * HOUR_MS + 4 * MINUTE_MS),
    unread: true,
  ...
  {
    id: "ntf_2",
    title: "Case awaiting verification",
    body: "QO-PA-2026-00418 is complete and evidenced, waiting on a reviewer",
    at: ago(2 * HOUR_MS + 57 * MINUTE_MS),
    unread: true,
    tone: "high" as const,
  },
  {
    ...
    body: "Sunil Joshi verified QO-PA-2026-00313",
    at: ago(4 * HOUR_MS + 38 * MINUTE_MS),
    unread: true,
