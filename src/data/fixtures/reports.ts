...
export const REPORT_SCHEDULES: ReportSchedule[] = [
  {
    ...
    cadence: "WEEKLY",
    recipients: ["elena.vasquez@northbridge-industrial.com", "marcus.reinhardt@northbridge-industrial.com"],
    isEnabled: true,
  ...
  },
  {
    ...
    cadence: "DAILY",
    recipients: ["marcus.reinhardt@northbridge-industrial.com", "priya.sharma@northbridge-industrial.com"],
    isEnabled: true,
  ...
  },
  {
    ...
    cadence: "MONTHLY",
    recipients: ["carlos.mendoza@northbridge-industrial.com"],
    isEnabled: true,
  ...
  },
  {
    ...
    cadence: "MONTHLY",
    recipients: ["sandra.whitfield@northbridge-industrial.com"],
    isEnabled: false,
...
export const REPORT_RUNS: ReportRun[] = [
  ...
  { id: "run_r004", templateId: "rpt_plant_scorecard", scheduleId: null, generatedAt: ago(3 * DAY_MS), status: "DELIVERED", rowCount: 19, recipients: 1, generatedBy: "Marcus Reinhardt", format: "CSV" },
